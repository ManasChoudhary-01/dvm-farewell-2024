      ...
      {items.map((item, index) => (
        <div className="carouselSection" key={index}>
          <div className="carouselTitle">
            <div className="carouselTitleText">Batch of '20</div>
          ...
          <div className="seniorImage">
            <img src={item.img} alt="sample" className="seniorImg" />
          </div>
          <div className="seniorInfo">
            <div className="seniorDetails">
              <div className="seniorName">{item.name}</div>
              <div className="seniorVertical">{item.vertical}</div>
            </div>
            <div className="verifyTick">
              <div className="tickCircle">
                ...
                >
                  <path
                    d="M16.9997 0.333496C26.2043 0.333496 33.6663 7.79541 33.6663 17.0002C33.6663 26.2048 26.2043 33.6668 16.9997 33.6668C7.79492 33.6668 0.333008 26.2048 0.333008 17.0002C0.333008 7.79541 7.79492 0.333496 16.9997 0.333496ZM22.3658 11.9496L14.9163 19.399L11.6336 16.1163C11.1454 15.6282 10.3539 15.6282 9.86579 16.1163C9.37764 16.6045 9.37764 17.3958 9.86579 17.884L14.0325 22.0507C14.5207 22.5388 15.312 22.5388 15.8002 22.0507L24.1335 13.7173C24.6217 13.2292 24.6217 12.4378 24.1335 11.9496C23.6453 11.4615 22.854 11.4615 22.3658 11.9496Z"
                    fill="#784BD2"
                  />
                </svg>
              </div>
